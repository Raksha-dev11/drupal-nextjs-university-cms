      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white/80 backdrop-blur-sm border-2 border-pink-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <h2 className="text-xl font-semibold text-pink-600 mb-4">My Courses</h2>
            <p className="text-gray-600 mb-4">View your enrolled courses and assignments</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Available Courses:</span>
          ...
          <div className="bg-white/80 backdrop-blur-sm border-2 border-purple-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <h2 className="text-xl font-semibold text-purple-600 mb-4">Academic Progress</h2>
            <p className="text-gray-600 mb-4">Track your academic achievements</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Total Credits:</span>
                <span className="font-semibold text-gray-800">{courseCount * 3}</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          <div className="bg-white/80 backdrop-blur-sm border-2 border-blue-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <h2 className="text-xl font-semibold text-blue-600 mb-4">Faculty Access</h2>
            <p className="text-gray-600 mb-4">Connect with instructors and staff</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
